...
filtered_peak_df_carnitines_MH <- read.csv("C:/Users/Calle/OneDrive - UC San Diego/Dorrestein Lab/Ming_bioinformatics/Manuscript/final_figures/files_for_boxplot_carnitine/filtered_peak_df_carnitines_M+H.csv")
...
peak_ratio_df_carnitines_MH <- read.csv("C:/Users/Calle/OneDrive - UC San Diego/Dorrestein Lab/Ming_bioinformatics/Manuscript/final_figures/files_for_boxplot_carnitine/peak_ratio_df_carnitines_M+H.csv")
...
filtered_peak_df_BA_di_3_7_MH <- read.csv("C:/Users/Calle/OneDrive - UC San Diego/Dorrestein Lab/Ming_bioinformatics/Manuscript/final_figures/files_for_boxplot_dihydroxy_BA/filtered_peak_df_BA_di_3_7_M+H.csv")
...
peak_ratio_df_BA_di_3_7_MH <- read.csv("C:/Users/Calle/OneDrive - UC San Diego/Dorrestein Lab/Ming_bioinformatics/Manuscript/final_figures/files_for_boxplot_dihydroxy_BA/peak_ratio_df_BA_di_3_7_M+H.csv")
...
carnitine_boxplot <- (
  ...
  + scale_y_continuous(
    ...
    sec.axis = dup_axis(name="Percent Occurrance"),
    limits = c(-1, 1),
    labels = abs
  )
...
ggsave("C:/Users/Calle/OneDrive - UC San Diego/Dorrestein Lab/Ming_bioinformatics/Manuscript/final_figures/carnitine_boxplot_final_fig.png", width = 4.5, height = 4, units ="in")
...
ggsave("C:/Users/Calle/OneDrive - UC San Diego/Dorrestein Lab/Ming_bioinformatics/Manuscript/final_figures/bileacid_boxplot_final_fig.png", width = 5, height = 4, units ="in")
